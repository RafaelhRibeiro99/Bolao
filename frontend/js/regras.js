const regras = [
  ...
  ['Taxa administrativa', 'Do valor pago em cada palpite aprovado, 5% ficam retidos internamente para a administração da plataforma. O participante não paga valor adicional.'],
  ...
  ['Premiação', 'A premiação corresponde ao valor dos palpites aprovados após a retenção da taxa administrativa de 5%.'],
